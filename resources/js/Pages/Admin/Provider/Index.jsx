...
const Index = ({ auth, providers, title }) => {
    ...
    function handleDelete(provider) {
        axios
            .delete(`/admin/provider/${provider.id}`)
            .then(() => {
            ...
            <Authenticated
                ...
                header={
                    <div className="justify-between flex">
                        ...
                        <button
                            id="modalType"
                            onClick={() => handleOpenModal("Add Provider")}
...
function Modal({
    ...
    function handleAdd() {
        if (!data.name || !data.photo || !data.slug) {
    ...
    console.log(data);
    function handleUpdate(provider) {
        if (data.name.trim() === "" || data.photo === "" || data.slug === "") {
            alert("Semua field wajib diisi");
            return;
        }

        axios
            .put(`/admin/provider/${provider.id}`, provider)
            .then(() => {
                setFilteredData((prev) =>
                    prev.map((item) =>
